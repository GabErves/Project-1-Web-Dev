...
const Conversion = () =>{
    ...
    {!loading && bpiData && <>
        ...
        <div className="align-items center"> 
            ...
            <p className=""><span className="">Current Time: </span> {Date(times)}</p> 
        </div>

        <button onClick={timeout} type="button" class="align-items center text-white bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium rounded-lg text-sm px-9 py-2.5 text-center mr-2 mb-2">
